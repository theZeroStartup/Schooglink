...
import com.zero.schooglink.databinding.FragmentTopLinksBinding
...
@AndroidEntryPoint
class TopLinksFragment: BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.etSearch.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(p0: Editable?) {
                ...
                dashboardVM.filter(query, dashboardVM.topLinksData.value)
            }
        })
    }
    ...
    private fun attachObservers() {
        ...
        dashboardVM.topLinksData.observe(viewLifecycleOwner) {
            stopLoading()
            if (it.isNotEmpty()) {
                showData()
